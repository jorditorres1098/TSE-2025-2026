...
\begin{enumerate}
    \item I recover the $w_j^{*}$ under the newly defined Bi. Given that I have been able to estimate b in the previous exercise, I can recover the reservation wage for the new $B_{f}$ by finding the fixed point of $w_j^{*}$ in this n
