...
preserve 
use "/Users/jorditorresvallverdu/Downloads/RD_sample.dta", clear
drop if time < 30
...
gen uij_cf= vij_cf+err //with just one draw
...
gsort id_teach -mix_uij
bys id_teach: gen rank = _n //not needed actually, but...


keep mix_uij n_plazas score id_school id_teach rank 
